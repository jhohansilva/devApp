...
-- Tiempo de generación: 26-06-2019 a las 21:59:13
...
CREATE TABLE `propiedades` (
  ...
  `nitPropietario` int(10) NOT NULL,
  `nitConjunto` int(10) NOT NULL,
  `fechaRegistro` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `propietarios` (
  `nit_prop` int(10) NOT NULL,
  `descrip_prop` varchar(100) NOT NULL,
  `tel1_prop` varchar(10) NOT NULL,
  `tel2_prop` varchar(10) NOT NULL,
  `correo_prop` varchar(60) NOT NULL,
  `clave_prop` varchar(100) NOT NULL,
  `fechaRegistro_prop` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `propietarios` (`nit_prop`, `descrip_prop`, `tel1_prop`, `tel2_prop`, `correo_prop`, `clave_prop`, `fechaRegistro_prop`) VALUES
(1, 'Jhohan F. Silva', '3124471699', '', 'jhohanf.silva@gmail.com', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', '2019-06-17 02:43:57'),
(52831556, 'BERMUDEZ  GOMEZ     DORYS MARIA         ', '3016682890', '3041689955', 'DORYXXSB@GMAIL.COM                                          ', '$2y$10$OqJW.O2NsjbIFQSNkrmoe.qfpVBRprzzkxl/y4gpwi3ZWhKqEuXti', '2019-06-21 02:05:08');
...
INSERT INTO `servidores` (`idServidor`, `ip`, `descripcion`) VALUES
(1, '45.58.34.159', 'Principal');
...
ALTER TABLE `propiedades`
  ...
  ADD KEY `idPropietario` (`nitPropietario`),
  ADD KEY `nitConjunto` (`nitConjunto`);

--
-- Indices de la tabla `propietarios`
--
ALTER TABLE `propietarios`
  ADD PRIMARY KEY (`nit_prop`);
...
--
ALTER TABLE `conjuntos`
  ADD CONSTRAINT `lnk_municipio` FOREIGN KEY (`idMunicipio`) REFERENCES `municipios` (`id_municipio`) ON UPDATE CASCADE,
  ADD CONSTRAINT `lnk_servidor` FOREIGN KEY (`idServidor`) REFERENCES `servidores` (`idServidor`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `municipios`
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `lnkMunicipio` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`id_departamento`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `propiedades`
--
ALTER TABLE `propiedades`
  ADD CONSTRAINT `lnk_nitconjunto` FOREIGN KEY (`nitConjunto`) REFERENCES `conjuntos` (`nit`) ON UPDATE CASCADE,
  ADD CONSTRAINT `lnk_propietario` FOREIGN KEY (`nitPropietario`) REFERENCES `propietarios` (`nit_prop`) ON UPDATE CASCADE;
COMMIT;
